...
urlpatterns = [
    ...
    # 2
    path('django/jsnoresponsefrommodel/', views.no_rest_from_model),
    ...
    # 4.2: GET PUT DELETE from rest framework function class view APIview
    path('rest/cbv/<int:pk>', views.CBV_pk.as_view()),

    # 5.1: GET POST from rest framework Class based view mixins
    path('rest/mixinslist/', views.mixins_list.as_view()),

    # 5.2: GET PUT DELETE from rest framework function class view mixins
    path('rest/mixins/<int:pk>/', views.mixins_pk.as_view()),

    # 6.1: GET POST from rest framework Class based view generics
    path('rest/generics/', views.generics_list.as_view()),

    # 6.2: GET PUT DELETE from rest framework function class view generics PK
    path('rest/generics/<int:pk>/', views.generics_pk.as_view()),

    # 7 viewsets
    path('rest/viewsets/', include(router.urls)),

    # 8 Find Movie using filer on postman
